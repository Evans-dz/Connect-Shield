...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    what: {
      ...
      body: "The Program for Evaluating Payment Patterns Electronic Report compares your hospice's billing against national and jurisdictional percentiles across target areas known to attract audit attention — long lengths of stay, live discharges, and continuous or general inpatient care among them. Landing above the 80th percentile on a target area doesn't prove anything is wrong, but it does put you on the map for review. PEPPER relaunched in June 2026 after a 2.5-year pause — fresh reports are landing again.",
    },
    points: [
  ...
  },
  {
    ...
    points: [
      { h: "Every survey document, one library", p: "Upload results, CMS-2567 statements, and plans of correction — typed, dated, searchable." },
  ...
  },
  {
    ...
    metaDescription:
      "Store your hospice policy manuals in one secure, searchable library — every document typed, dated, and ready when a surveyor asks. Zero PHI stored.",
  ...
  },
  {
    ...
    term: "Chart Audit",
    nav: "Chart Audit",
    metaTitle: "Hospice Chart Review & Survey Readiness — Plain English",
    metaDescription:
