...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    term: "Chart Audit",
    nav: "Chart Audit",
    metaTitle: "Hospice Chart Audit Tool — Plain-English CoP Review",
    metaDescription:
      "Paste or upload any hospice chart, note, or report for a plain-English breakdown — or a CoP audit citing the regulation per finding. Zero PHI stored.",
    keywords: ["hospice chart audit", "hospice chart audit tool", "hospice documentation review", "hospice CoP compliance", "hospice clinical record audit", "42 CFR 418"],
    hero: {
      kicker: "Clinical Record & Documentation Review",
      title: "Paste any chart, note, or report. Get the plain-English read.",
      sub: "Connect Shield breaks clinical documentation down in seconds — and its CoP audit mode checks each record against the Medicare Conditions of Participation, citation included.",
    },
    what: {
      title: "What a chart audit gives you",
      body: "Paste or upload a chart, visit note, or report and Connect Shield returns a plain-English breakdown of what's documented and what's thin. Switch to CoP audit mode and each record is checked against the Medicare Conditions of Participation at 42 CFR Part 418, with the specific regulation cited for every finding — so your team knows exactly which requirement to read. Documents are analyzed in memory and never stored.",
    },
    points: [
      ...
      { h: "CoP audit mode", p: "Documentation checked against the Conditions of Participation, with the 42 CFR 418 citation attached to each finding." },
    ...
    faqExtra: [
      { q: "Is this a compliance determination?", a: "No. Chart audit results are informational — they point out where documentation may not align with a Condition of Participation and cite the regulation so your team can review it. Only a surveyor determines compliance." },
    ],
  },
];
