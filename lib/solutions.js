...
export const SOLUTIONS = [
  {
    ...
    metaDescription:
      "Look up your hospice's CMS SSVI score (0–16) and see all nine claims-based measures broken down. Published FY2025 scores for 6,643 US hospices. Zero PHI stored.",
  ...
  },
  {
    ...
    nav: "CAHPS Tracking",
    metaTitle: "CAHPS Hospice Survey Tracking & Analysis",
    metaDescription:
      "Track your CAHPS Hospice Survey scores against national averages and see which measures pull your rating down. Executive-level reporting. Zero PHI stored.",
  ...
  },
  {
    ...
    term: "QAPI Program",
    nav: "QAPI Management",
    metaTitle: "Hospice QAPI Program Support & Project Tracking",
    metaDescription:
      "Organize your hospice QAPI program, tie performance improvement projects to your real compliance data, and keep survey-ready documentation. Zero PHI stored.",
