...
export const SOLUTIONS = [
  {
    ...
    metaDescription:
      "Look up your hospice's CMS SSVI score (0–16) and see all nine claims-based measures broken down. Published FY2024 & FY2025 scores for all 7,059 US hospices. HIPAA-compliant.",
  ...
  },
  {
    ...
    metaDescription:
      "Upload your hospice PEPPER report and see your outlier target areas explained in plain terms, with the billing patterns behind each flag. Executive-level, HIPAA-compliant.",
  ...
  },
  {
    ...
    metaDescription:
      "Track your CAHPS Hospice Survey scores against national averages and see which measures pull your rating down. Clear, executive-level reporting, HIPAA-compliant.",
  ...
  },
  {
    ...
    metaDescription:
      "Organize your hospice QAPI program, tie performance improvement projects to your real compliance data, and keep survey-ready documentation. Executive-level, HIPAA-compliant.",
  ...
  },
  {
    ...
    metaDescription:
      "Upload your PS&R Report 810 and get RN visit intensity, length of stay, reimbursement, and SSVI risk drivers calculated automatically. Executive reporting, HIPAA-compliant.",
  ...
  },
  {
    ...
    metaDescription:
      "Turn your Beneficiary Count report into a live Medicare aggregate CAP calculation with clawback exposure. Know if you're over the cap before CMS does. HIPAA-compliant.",
  ...
  },
  {
    ...
    metaDescription:
      "Track hospice survey deficiencies, condition-level citations, and open findings against Medicare Conditions of Participation. Stay survey-ready with clear reporting. HIPAA-compliant.",
  ...
  },
  {
    ...
    metaDescription:
      "Store your hospice policy manuals in one secure library and check them against Medicare Conditions of Participation. Keep survey-ready documentation. HIPAA-compliant.",
