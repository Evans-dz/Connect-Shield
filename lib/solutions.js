// The nine SEO landing pages. Each entry becomes /[slug] as a real,
...
export const SOLUTIONS = [
  {
    ...
    term: "SSVI Score",
    nav: "SSVI Scoring",
    metaTitle: "SSVI Score Lookup: Free for All 6,643 US Hospices",
    metaDescription:
      "Free SSVI score lookup, no signup: your hospice's published FY2025 CMS score (0–16) and all nine measures, for 6,643 US hospices. Zero PHI stored.",
    keywords: ["SSVI score", "Service and Spending Variation Index", "hospice SSVI lookup", "CMS-1851-F", "hospice program integrity"],
    hero: {
    ...
    what: {
      ...
      body: "Finalized in the FY2027 hospice final rule (July 30, 2026) and effective October 1, 2026, the Service and Spending Variation Index is a single 0–16 score built from nine claims-based metrics. It combines a Non-Hospice Spending Score (0–8) with a Utilization Score (0–8) drawn from eight service-delivery measures. A higher score signals greater deviation from peer norms, and scores at the high end can trigger program-integrity review.",
    },
    points: [
      { h: "Your exact published number", p: "We load the CMS SSVI file directly and show your published FY2025 score, not an estimate." },
      ...
      { h: "Benchmarked to the field", p: "National average is 6.42, median 7. We place you against all 6,643 scored hospices." },
    ],
    faqExtra: [
  ...
  },
  {
    ...
    metaDescription:
      "Upload your hospice PEPPER report and see each outlier target area explained in plain terms, with the billing patterns behind it. Zero PHI stored.",
    ...
    what: {
      ...
      body: "The Program for Evaluating Payment Patterns Electronic Report compares your hospice's billing against national and jurisdictional percentiles across target areas known to attract audit attention, including long lengths of stay, live discharges, and continuous or general inpatient care. Landing above the 80th percentile on a target area doesn't prove anything is wrong, but it does put you on the map for review. PEPPER relaunched in June 2026 after a 2.5-year pause, so fresh reports are landing again.",
    },
    points: [
  ...
  },
  {
    ...
    nav: "CAHPS Tracking",
    metaTitle: "Hospice CAHPS Scores: Track & Compare Your Survey Results",
    metaDescription:
      "Track your hospice CAHPS scores against the national average: every survey measure, trends over time, and board-ready executive reporting. Zero PHI stored.",
  ...
  },
  {
    ...
    term: "QAPI Program",
    nav: "QAPI Management",
    metaTitle: "Hospice QAPI Tracking & Performance Improvement Projects",
    metaDescription:
      "Hospice QAPI tracking that ties performance improvement projects to your real compliance data, with survey-ready documentation throughout. Zero PHI stored.",
  ...
  },
  {
    ...
    term: "PS&R Summary",
    nav: "PS&R Summary",
    metaTitle: "Hospice PS&R Summary Analysis (Report 810)",
    metaDescription:
      "Upload your PS&R Report 810 and get RN visit intensity, length of stay, reimbursement, and SSVI risk drivers calculated automatically. Zero PHI stored.",
  ...
  },
  {
    ...
    metaTitle: "Hospice Beneficiary Count & Medicare CAP Exposure",
    metaDescription:
      "Turn your Beneficiary Count report into a live Medicare aggregate CAP calculation with clawback exposure. Know if you're over before CMS does. Zero PHI stored.",
    keywords: ["hospice beneficiary count", "beneficiary count report", "medicare aggregate cap", "hospice cap exposure", "hospice clawback"],
    hero: {
      kicker: "Beneficiary Count Report",
    ...
    what: {
      ...
      body: "The Medicare aggregate cap limits total reimbursement to your beneficiary count times the annual per-beneficiary cap amount. Exceed it and CMS claws back the difference, often a devastating six-figure demand arriving months after the cap year closes. The Beneficiary Count report holds the number that drives it, and most owners don't run the math until it's too late.",
    },
    points: [
      { h: "Live cap calculation", p: "Beneficiaries × per-cap amount against your net reimbursement, so you see exposure in real time." },
  ...
  },
  {
    ...
    term: "Survey Results",
    nav: "Survey Results",
    metaTitle: "Hospice Survey Results & Deficiency Tracking",
    metaDescription:
      "Keep hospice survey results, CMS-2567 deficiency statements, and plans of correction in one organized, survey-ready library with review support. Zero PHI stored.",
    ...
    hero: {
      ...
      sub: "Connect Shield keeps your survey results, deficiency statements, and plans of correction organized in one reviewed, dated library, so nothing surprises you.",
    },
    what: {
    ...
    points: [
      { h: "Every survey document, one library", p: "Upload results, CMS-2567 statements, and plans of correction. Each is typed, dated, and searchable." },
      { h: "Condition-level findings visible", p: "The serious citations stay front and center, not buried in a drive." },
      { h: "Review support", p: "Walk your findings with our team and keep review notes alongside each document." },
  ...
  },
  {
    ...
    term: "Policy Manuals",
    nav: "Policy Manuals",
    metaTitle: "Hospice Policy Manual Review & Compliance Library",
    metaDescription:
      "Store your hospice policy manuals in one secure, searchable library, with every document typed, dated, and ready when a surveyor asks. Zero PHI stored.",
    ...
    hero: {
      ...
      sub: "Keep your manuals, procedures, and compliance documents in one place: organized, searchable, and ready the moment a surveyor asks.",
    },
    what: {
    ...
    points: [
      ...
      { h: "Review support", p: "Work with our team to review your library and note where a policy may be due for an update." },
  ...
  },
  {
    ...
    term: "Chart Audit",
    nav: "Chart Audit",
    metaTitle: "Hospice Chart Review & Survey Readiness in Plain English",
    metaDescription:
      "Paste or upload any hospice chart, note, or report for a plain-English breakdown, or a survey-readiness review with gaps and prep steps. Zero PHI stored.",
    keywords: ["hospice chart audit", "hospice chart audit tool", "hospice documentation review", "hospice CoP compliance", "hospice clinical record audit", "42 CFR 418", "hospice survey readiness", "hospice survey preparation"],
    hero: {
      kicker: "Document Review & Survey Readiness",
      title: "Paste any chart, note, or report. Get the plain-English read.",
      sub: "Connect Shield breaks any document down in seconds, and its survey-readiness mode shows you what a surveyor would notice, where the gaps are, and what to prepare next.",
    },
    what: {
      title: "What a document review gives you",
      body: "Paste or upload a chart, visit note, policy, QAPI minutes, or report and Connect Shield returns a plain-English breakdown of what's documented and what's thin. Switch to survey-readiness mode and the same document is read the way a surveyor would read it: what they'd notice, the gaps worth closing before they walk in, what the document shows you already do well, and a prioritized prep list. Documents are analyzed in memory and never stored.",
    },
    points: [
      { h: "Plain-English breakdown", p: "Any chart, note, or report translated into a clear read on what's documented. No decoder ring required." },
      { h: "Survey-readiness mode", p: "See your document through a surveyor's eyes: what they'd notice, the gaps to close, and the prep steps to take, from whatever document you have on hand." },
      { h: "Analyzed in memory, never stored", p: "Nothing you paste or upload is saved. Documents are processed and discarded. Zero PHI stored." },
      { h: "Built with an operator", p: "Developed alongside a 20-year hospice owner-operator, so findings read the way a working clinical review does." },
    ],
    faqExtra: [
      { q: "Is this a compliance determination?", a: "No. Results are informational survey preparation. They show what a surveyor reviewing your document would likely notice and the prep steps worth taking. They are not per-regulation verdicts, and only a surveyor determines compliance." },
    ],
  },
];
