...
export function buildSignals({ metrics = {}, ssvi = null, pepper = null, cahps = null, qapi = null, suppress = [] } = {}) {
  ...
  //
  // IMPORTANT, and validated against the pilot clinic's billing system in Aug 2026:
  ...
  // figures converge — the pilot clinic's $149K exposure matched their MAC cap number
