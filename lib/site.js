...
export const FAQ = [
  ...
  {
    q: "Is the SSVI final?",
    a: "Yes. CMS finalized the SSVI in the FY2027 hospice final rule on July 30, 2026. It takes effect October 1, 2026. The scores shown here are the published CMS file — and CMS is explicit the SSVI is not a determination of fraud, waste, or abuse. We update as CMS releases new data.",
  },
  {
