...
export const SITE = {
  ...
  // Agency credit shown in the footer bar.
  credit: {
    label: "EZHD",
    href: "https://ez-hd.co",
  },
...
export const FAQ = [
  ...
  },
  {
    ...
    a: "Directly from the CMS Service and Spending Variation Index file published with the FY2027 hospice final rule. We load every scored US hospice and show your exact published number, not an estimate.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. For any CCN in the CMS file we display the published FY2025 score, plus the prior year where CMS published one. Every one of the eight utilization flags we show reconciles to the CMS-published utilization score, so the breakdown always adds up to your official number.",
  },
  {
    q: "Is the SSVI final?",
    a: "Yes. CMS finalized the SSVI in the FY2027 hospice final rule on July 30, 2026. It takes effect October 1, 2026. The scores shown here are the published CMS file, and CMS is explicit that the SSVI is not a determination of fraud, waste, or abuse. We update as CMS releases new data.",
  },
  {
