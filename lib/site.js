...
export const SITE = {
  ...
  description:
    "Connect Shield turns CMS claims data into a clear compliance picture for hospice leadership — your published SSVI score, PEPPER outliers, CAP exposure, and survey readiness in one secure, encrypted dashboard. We work only from public CMS data and the reports you provide — never patient records.",
};
...
export const STATS = [
  ...
  { value: "Encrypted", label: "end-to-end, per-clinic isolated" },
];
...
export const COMPETITORS = {
  ...
  rows: [
    { feature: "Published SSVI score lookup", cs: true, competitorA: true, competitorB: "partial" },
    { feature: "All 9 measures broken down with your values", cs: true, competitorA: "partial", competitorB: false },
    { feature: "Reads your PS&R, PEPPER & CAHPS reports", cs: true, competitorA: false, competitorB: false },
    { feature: "CAP exposure & clawback estimate", cs: true, competitorA: false, competitorB: false },
    { feature: "AI chart & CoP auditor", cs: true, competitorA: false, competitorB: false },
    { feature: "Per-clinic secure portal", cs: true, competitorA: false, competitorB: "partial" },
    { feature: "Encrypted infrastructure", cs: true, competitorA: true, competitorB: true },
  ],
};
...
export const FAQ = [
  {
    q: "Is my data secure?",
    a: "Yes. Connect Shield works from CMS agency-level claims data and the reports you upload — never patient names or diagnoses — and everything is encrypted in transit and at rest. Each clinic's portal is isolated, so only your team can ever see your data.",
  },
  {
